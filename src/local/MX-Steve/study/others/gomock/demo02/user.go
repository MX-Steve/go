...
//go:generate mockgen -destination mock_user_test.go -package user_test local/MX-Steve/study/others/gomock/demo02 Index,Embed,Embedded

// Random bunch of imports to test mockgen.
import (
	"io"
	"local/MX-Steve/study/others/gomock/demo02/imp1"
	...
	renamed2 "local/MX-Steve/study/others/gomock/demo02/imp2"

	imp3 "local/MX-Steve/study/others/gomock/demo02/imp3"

	imp_four "local/MX-Steve/study/others/gomock/demo02/imp4"
)
